...
A code indicating if any information about the traffic regulation has been flagged as suspect.

EXAMPLE: valid, missing traffic control device - still in effect, missing traffic control device - not in effect until installed, under investigation - additional reports accepted, under investigation - do not report, etc.

**IRI**: `https://w3id.org/itsdata/regulation/v1/SuspectStatusCode`
...
=== "SVG (interactive)"
    ...
    <title>SuspectStatusCode</title>
    <g id="a_node3"><a xlink:href="../SuspectStatusCode" xlink:title="&lt;TABLE&gt;">
    <polygon fill="lightgray" stroke="none" points="26.5,-25.88 26.5,-42.12 135,-42.12 135,-25.88 26.5,-25.88"/>
    <text xml:space="preserve" text-anchor="start" x="27.5" y="-29.88" font-family="Arial" font-size="12.00">SuspectStatusCode</text>
    <polygon fill="none" stroke="black" points="25.5,-24.88 25.5,-43.12 136,-43.12 136,-24.88 25.5,-24.88"/>
    </a>
    </g>
    </g>
    <!-- SuspectStatusCode&#45;&gt;cdm2_Code -->
    <g id="edge1" class="edge">
    <title>SuspectStatusCode&#45;&gt;cdm2_Code</title>
    ...
    <!-- SuspectStatusCode&#45;&gt;RegulationThing -->
    <g id="edge2" class="edge">
    <title>SuspectStatusCode&#45;&gt;RegulationThing</title>
...
=== "PNG"
    ...
    ![SuspectStatusCode Diagram](../diagrams/SuspectStatusCode.dot.png)



## Formalization for SuspectStatusCode
